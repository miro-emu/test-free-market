    ...
    <form action="/sell" method="post" enctype="multipart/form-data">
        ...
        <div class="">
            ...
            <div clss="form-group">
                ...
                <input class="item-content__name" type="text" name="name" id="name" value="{{ old('name') }}">
                @error('name')
                <p class="error">{{ $message }}</p>
                @enderror
            </div>
            <div clss="form-group">
                ...
                <input class="item-content__brand" type="text" name="brand" id="brand" value="{{ old('brand') }}">
            </div>
            <div clss="form-group">
                <label class="item-content__header" for="description">商品の説明</label>
                <textarea class="item-content__description" name="description" id="description">{{ old('description') }}</textarea>
                @error('description')
                <p class="error">{{ $message }}</p>
                @enderror
            </div>
            <div clss="form-group">
                ...
                <input class="item-content__price" type="text" name="price" id="price" value="{{ old('price') }}">
                @error('price')
                <p class="error">{{ $message }}</p>
                @enderror
            </div>
